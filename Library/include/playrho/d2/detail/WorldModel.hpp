...
struct WorldModel final : WorldConcept {
    ...
    {
        return std::make_unique<WorldModel>(data);
    }

    cista::offset::unique_ptr<WorldModel> Clone() const
    {
        return cista::offset::make_unique<WorldModel>(data);
    }
    ...
    cista::offset::vector<ShapeID> GetShapes_(BodyID id) const override
    {
