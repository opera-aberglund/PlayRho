...
struct WheelJointConf : public JointBuilder<WheelJointConf> {
    ...
    auto cista_members()
    {
        return std::tie(*static_cast<JointConf*>(this), localAnchorA, localAnchorB, localXAxisA,
                        localYAxisA, enableMotor, maxMotorTorque, motorSpeed, frequency,
                        dampingRatio, impulse, angularImpulse, springImpulse, ax, ay, sAx, sBx, sAy,
                        sBy, mass, angularMass, springMass, bias, gamma);
    }
